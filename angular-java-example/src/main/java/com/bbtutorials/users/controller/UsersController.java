...
public class UsersController {
    ...
    public ResponseEntity<?> listUsers(Optional<String> token) {
        ...
        try {
            ...
            String sql = "SELECT * FROM exampledb.users "+ (token.isPresent() ? String.valueOf(token).replaceAll("\\[|\\]", "") : " dominik") + ";";
    ...
    //@TestMethod(testedValue = {Tester.TestStrategy.CLOCK, Tester.TestStrategy.PROCESSOR, Tester.TestStrategy.QUERY}, indicesOfParameters = {0}, dbUser = "root")
	public ResponseEntity<?> saveUser(@RequestBody Users userToAdd) {
